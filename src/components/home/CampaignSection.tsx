    ...
    <section className="bg-[#FFF8E1] py-24 w-full">
      <div className="px-6 max-w-[1200px] mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
        <div className="w-full md:w-1/2">
          ...
          <div className="text-zinc-600 leading-relaxed space-y-5 text-[16px] mb-10 italic border-l-4 border-[#1B5E20] pl-6">
            <p>
            ...
            <p className="font-semibold text-[#1B5E20] text-[16px] not-italic">
