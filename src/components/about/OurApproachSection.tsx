      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {principles.map((principle, index) => (
            <div
              key={index}
              className={`group bg-white p-8 border border-zinc-100 hover:border-[#24a186]/30 hover:shadow-lg transition-all duration-300 ${
                index === 6
                  ? "sm:col-span-2 lg:col-span-1 lg:max-w-[394px] lg:mx-auto"
                  : ""
              }`}
            >
              <div className="w-14 h-14 bg-[#EAF5F3] flex items-center justify-center rounded-full mb-5 group-hover:bg-[#24a186] transition-colors duration-300">
                <principle.icon
                  size={24}
